...
// Préstamos hardcodeados (fallback — sin BD conectada)
// Basados en los gastos financieros: el pico de 2024 ($56M en intereses)
// con tasa promedio ~8% anual implica capital de ~$700M en créditos vigentes
const PRESTAMOS_FALLBACK: Prestamo[] = [
  {
    id: 1,
    ...
    tipo_acreedor: 'banco',
    monto_original: 500_000_000,
    tasa_interes: 7.5,
    plazo_meses: 48,
    monto_pendiente: 180_000_000,
    estado: 'vigente',
    numero_contrato: 'CRE-2022-0341',
  ...
  },
  {
    ...
    acreedor_rut: '97.030.000-7',
    acreedor_nombre: 'Banco de Chile',
    tipo_acreedor: 'banco',
    monto_original: 300_000_000,
    tasa_interes: 8.2,
    plazo_meses: 36,
    monto_pendiente: 195_000_000,
    estado: 'vigente',
    numero_contrato: 'CRE-2023-1187',
  ...
  },
  {
    ...
    acreedor_rut: '97.004.000-5',
    acreedor_nombre: 'Banco Santander',
    tipo_acreedor: 'banco',
    monto_original: 200_000_000,
    tasa_interes: 9.1,
    plazo_meses: 24,
    monto_pendiente: 87_000_000,
    estado: 'vencido',  // venció 2026-01-10 — requiere renegociación o pago
    numero_contrato: 'CRE-2024-0055',
  ...
  },
  {
    ...
    acreedor_rut: '97.036.000-K',  // Scotiabank Chile
    acreedor_nombre: 'Scotiabank Chile — Mutuo Hipotecario (sede central)',
    tipo_acreedor: 'banco',
    monto_original: 280_000_000,
    tasa_interes: 5.8,
    plazo_meses: 120,
    monto_pendiente: 220_000_000,
    estado: 'vigente',
    numero_contrato: 'MH-SCO-2023-0089',
    fecha_vencimiento: '2033-06-01',
    es_legal: true,
    alerta_legal: null,
  },
  {
    ...
    tipo_acreedor: 'otro',
    monto_original: 4_942_000,
    tasa_interes: null,
    plazo_meses: null,
    monto_pendiente: 4_942_000,
    estado: 'vigente',

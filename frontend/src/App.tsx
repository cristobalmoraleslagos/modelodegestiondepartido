...
// ─── Nómina real Q1 2026 — Fuente: Módulo 14 Transferencias PP007 (315 filas) ─
// Sueldos = promedio mensual Q1 (total trimestral / 3).
// Todos confirmados con RUT en Transferencias SERVEL excepto donde se indica "estimado".
const FUNCIONARIOS_INIT: Funcionario[] = [
  ...
  // RUT confirmado en Transferencias Q1 2026 (row 315: 08.178.828-6)
  ...
  // Confirmados en Transferencias Q1 2026 — honorarios recurrentes
